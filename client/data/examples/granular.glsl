  ...
  // This example was made with a granular env of type "confined gaussian", min. grain length of 0.0101, max. grain length of 0.01 and almost no spread.
  ...
  void main () {
    ...
    float grains_start = mod(globalTime / 8., 0.999);
